...
Tali Forth uses the lowest part of the top half of the Zero Page<span class="indexterm" primary="Zero Page"></span> for the Data Stack (DS). This leaves the lower half of the Zero Page
...
danger of underflow,<span class="indexterm" primary="underflow"></span> it is recommended that the user kernel’s
